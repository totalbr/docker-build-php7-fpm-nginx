...
# Cabeçalho
echo ' '
printf "${GREEN}https://github.com/totalbr/docker-build-php7-fpm-nginx for the canonical source repository \n"
printf "Environment Ubuntu, php7-fpm and nginx, container for execution diffs e-cidade\n"
echo ' '
